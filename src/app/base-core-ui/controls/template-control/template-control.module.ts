...
import { AppControlModule_VerticalHorizontalListControl } from '../vertical-horizontal-list/vertical-horizontal-list.module';
...
@NgModule({
  ...
  exports: [TemplateControlComponent],
  bootstrap: [TemplateControlComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA, NO_ERRORS_SCHEMA],
})
export class AppControlModule_TemplateControlControl {}
